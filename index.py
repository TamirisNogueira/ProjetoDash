        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row([
                        dbc.Col([                            
                            html.Img(src='assets/Foto.jpeg', style={'width': '100px', 'height': 'auto', 'margin': '0 auto'}),                
                            html.Legend("Tamiris Nogueira")
                        ], sm=8, style={'text-align': 'center'}),
                        # dbc.Col([        
                    ...
                    dbc.Row([
                        dbc.Button("Visite o LinkedIn", href="https://www.linkedin.com/in/tamiris-nogueira-0a35ab165/?trk=opento_sprofile_topcard", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
